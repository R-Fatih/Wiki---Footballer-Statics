...
namespace Wiki___Footballer_Statics.Services.Concrete
{
    public static class MatchService
    {
        ...
        public static async Task<bool> AddMatchWithDetails(Classes.Match match,List<MatchLineUp> homeLU, List<MatchLineUp> awayLU, List<MatchEvent> events)
        {
            ...
            try
            {
                ...
                events.ForEach(x => x.MatchId = match.Id);
